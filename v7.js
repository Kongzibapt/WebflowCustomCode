...
const tool_img_zapier = Array.from(document.getElementsByClassName("tool-img zapier"));
const tool_img_zapier_black = Array.from(document.getElementsByClassName("tool-img zapier black"));
const tool_img_airtable = Array.from(document.getElementsByClassName("tool-img airtable"));
const tool_img_airtable_black = Array.from(document.getElementsByClassName("tool-img airtable black"));
const tool_img_bubble = Array.from(document.getElementsByClassName("tool-img bubble"));
const tool_img_bubble_black = Array.from(document.getElementsByClassName("tool-img bubble black"));
const tool_img_softr = Array.from(document.getElementsByClassName("tool-img softr"));
const tool_img_softr_black = Array.from(document.getElementsByClassName("tool-img softr black"));
const tool_img_make = Array.from(document.getElementsByClassName("tool-img make"));
const tool_img_make_black = Array.from(document.getElementsByClassName("tool-img make black"));
const tool_img_glide = Array.from(document.getElementsByClassName("tool-img glide"));
const tool_img_glide_black = Array.from(document.getElementsByClassName("tool-img glide black"));
...
const resource_back = Array.from(document.getElementsByClassName("resource-back"));
const resource_back_light = Array.from(document.getElementsByClassName("resource-back light"));
const warning = Array.from(document.getElementsByClassName("warning"));
const team_button_white = Array.from(document.getElementsByClassName("team-button-white"));
const rich_text_block = Array.from(document.querySelectorAll(".rich-text-block h3"));
  ...
  tool_img_zapier ? tool_img_zapier.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_zapier_black ? tool_img_zapier_black.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_airtable ? tool_img_airtable.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_airtable_black ? tool_img_airtable_black.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_bubble ? tool_img_bubble.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_bubble_black ? tool_img_bubble_black.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_softr ? tool_img_softr.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_softr_black ? tool_img_softr_black.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_make ? tool_img_make.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_make_black ? tool_img_make_black.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_glide ? tool_img_glide.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_glide_black ? tool_img_glide_black.forEach(el => el.style.cssText += "display:block;") : null;
  
  filter_item_reset ? filter_item_reset.forEach(el => el.style.cssText += "background-color:#0d0a28;color:#ffffff;") : null;
  type_text ? type_text.forEach(el => el.style.cssText += "background-color:#ffffff;") : null;
  resource_back ? resource_back.forEach(el => el.style.cssText += "display:none;") : null;
  resource_back_light ? resource_back_light.forEach(el => el.style.cssText += "display:block;") : null;
  warning ? warning.forEach(el => el.style.cssText += "background-color:rgba(73, 112, 240, 0.15);rgba(73, 112, 240, 1)") : null;
  team_button_white ? team_button_white.forEach(el => el.style.cssText += "background-color:#0d0a28;color:#ffffff;") : null;
  
  rich_text_block ? rich_text_block.forEach(el => el.style.cssText += "background-color:rgba(0, 0, 0, 0);color:#4970F0;") : null;
...
//   navlink_button ? navlink_button.forEach(el => el.style.cssText += "color:#ffffff;") : null;
  ...
  tool_img_zapier ? tool_img_zapier.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_zapier_black ? tool_img_zapier_black.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_airtable ? tool_img_airtable.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_airtable_black ? tool_img_airtable_black.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_bubble ? tool_img_bubble.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_bubble_black ? tool_img_bubble_black.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_softr ? tool_img_softr.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_softr_black ? tool_img_softr_black.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_make ? tool_img_make.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_make_black ? tool_img_make_black.forEach(el => el.style.cssText += "display:none;") : null;
  tool_img_glide ? tool_img_glide.forEach(el => el.style.cssText += "display:block;") : null;
  tool_img_glide_black ? tool_img_glide_black.forEach(el => el.style.cssText += "display:none;") : null;
  
  filter_item_reset ? filter_item_reset.forEach(el => el.style.cssText += "background-color:#ffffff;color:#0d0a28;") : null;
  type_text ? type_text.forEach(el => el.style.cssText += "background-color:#0d0a28;") : null;
  resource_back ? resource_back.forEach(el => el.style.cssText += "display:block;") : null;
  resource_back_light ? resource_back_light.forEach(el => el.style.cssText += "display:none;") : null;
  warning ? warning.forEach(el => el.style.cssText += "background-color:rgba(255, 255, 255, 0.15);color:#ffffff") : null;
  team_button_white ? team_button_white.forEach(el => el.style.cssText += "color:#0d0a28;background-color: rgba(0, 0, 0, 0.05);") : null;

  rich_text_block ? rich_text_block.forEach(el => el.style.cssText += "background-color:#4970F0;color:#ffffff;") : null;    
