...
const menu_icon = Array.from(document.getElementsByClassName("menu-icon"));
...
function switchMode() {
  ...
  menu_icon ? menu_icon.forEach(el => el.style.cssText += "color:#0d0a28;") : null;
  ...
  filter_item ? filter_item.forEach(el => el.style.cssText += "border-color:rgba(255, 255, 255, 0.2);background-color:rgba(73, 112, 240, 0.1)") : null;
  ...
  menu_icon ? menu_icon.forEach(el => el.style.cssText += "color:#ffffff;") : null;
