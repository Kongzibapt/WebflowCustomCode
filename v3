...
const team_button_white = Array.from(document.getElementsByClassName("team-button white"));
  ...
  warning ? warning.forEach(el => el.style.cssText += "background-color:rgba(73, 112, 240, 0.15);") : null;
...
//   navlink_button ? navlink_button.forEach(el => el.style.cssText += "color:#ffffff;") : null;
  ...
  warning ? warning.forEach(el => el.style.cssText += "background-color:rrgba(255, 255, 255, 0.15);") : null;
